      ...
      ?>
          <div class="activity-box-w">
            <div class="activity-box" <?php if($notify['status'] == 0):?> style="background-color: rgb(57, 162, 217, .1); z-index: 100;"<?php endif;?>>
              ...
              <a onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')" href="<?php echo base_url();?>teacher/notification/delete/<?php echo $notify['id'];?>"><i style="z-index: 100; float: right;" class="picons-thin-icon-thin-0153_delete_exit_remove_close" title="Delete"></i></a>
