	...
	<div class="os-tabs-w menu-shad">
		<div class="os-tabs-controls">
		  <ul class="nav nav-tabs upper">
			...
			<li class="nav-item">
			  <a class="nav-link active" href="<?php echo base_url();?>teacher/homework/"><i class="os-icon picons-thin-icon-thin-0014_notebook_paper_todo"></i><span><?php echo get_phrase('homework');?></span></a>
			</li>
			<li class="nav-item">
		  ...
		  <div class="table-responsive">
			...
			<tbody>
			 <?php
    			...
    			$homeworks = $this->db->get_where('homework', array('user' => 'teacher', 'uploader_id' => $this->session->userdata('login_user_id')))->result_array();
