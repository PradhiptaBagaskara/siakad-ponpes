...
<ul class="breadcrumb hidden-xs-down hidden-sm-down">
	<div class="back">
		<a href="<?php echo base_url();?>teacher/noticeboard/"><i class="os-icon os-icon-common-07"></i></a>
	</div>
	</ul>
  <div class="content-i">
    <div class="content-box">
		...
		<div class="element-box shadow lined-success">
		  <div class="row" style="margin:2px;margin-bottom:15px">
                       <input type="hidden" value="<?php echo $code;?>" id="news_code" name="news_code"/>
...
<script>
	...
	$(document).ready(function()
	{
	  $("#add").click(function()
	  {
	  	...
	  	if(message!="" && news_code!="")
	  	{
		  	$.ajax({url:"<?php echo base_url();?>teacher/news_message/add/",type:'POST',data:{message:message,news_code:news_code},success:function(result)
		  	{
