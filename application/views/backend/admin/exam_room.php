...
<div class="content-w">
	  <div class="os-tabs-w menu-shad">
		<div class="os-tabs-controls">
		  <ul class="nav nav-tabs upper">
			<li class="nav-item">
			  <a class="nav-link active" href="<?php echo base_url();?>admin/examroom/<?php echo $exam_code;?>/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo get_phrase('exam_details');?></span></a>
			</li>
			<li class="nav-item">
  ...
  <div class="content-i">
	...
	<a href="<?php echo base_url();?>admin/online_exams/"><i class="os-icon os-icon-common-07"></i></a>	
</div>
	<div class="row">	
	<div class="col-sm-8">
