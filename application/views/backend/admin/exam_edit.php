	  ...
	  <div class="os-tabs-w menu-shad">
		<div class="os-tabs-controls">
		  <ul class="nav nav-tabs upper">
			...
			<li class="nav-item">
			  <a class="nav-link" href="<?php echo base_url();?>admin/exam_questions/<?php echo $exam_code;?>/"><i class="os-icon picons-thin-icon-thin-0067_line_thumb_view"></i><span><?php echo get_phrase('questions');?></span></a>
			</li>
			<li class="nav-item">
			...
			<li class="nav-item">
			  <a class="nav-link active" href="<?php echo base_url();?>admin/exam_edit/<?php echo $exam_code;?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo get_phrase('edit');?></span></a>
			</li>
		  </ul>
		</div>
	  </div>
	...
	<div class="col-sm-8">
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<?php echo form_open(base_url() . 'admin/online_exams/edit/' . $row['exam_code'], array('enctype' => 'multipart/form-data')); ?>
			  ...
			  <div class="row">
				  <div class="col-sm-3">
					<div class="form-group">
					  <label for=""> <?php echo get_phrase('start_date');?></label><input class="single-daterange form-control" required="" type="text" value="<?php echo $row['availablefrom']; ?>" name="availablefrom">
					</div>
				  </div>
				  <div class="col-sm-3">
					<div class="form-group">
				  ...
				  <div class="col-sm-3">
					<div class="form-group">
					  <label for=""> <?php echo get_phrase('end_date');?></label><input class="single-daterange form-control" required="" type="text" value="<?php echo $row['availableto']; ?>" name="availableto">
					</div>
				  </div>
				  <div class="col-sm-3">
					<div class="form-group">
