<?php $reports = $this->db->get_where('reporte_alumnos', array('report_code' => $report_code))->result_array();
			foreach($reports as $row):
?>
<div class="content-w">
	<ul class="breadcrumb hidden-xs-down hidden-sm-down">
	<div class="back">
		<a href="<?php echo base_url();?>admin/request_student/"><i class="os-icon os-icon-common-07"></i></a>
	</div>
	</ul>
  <div class="content-i">
	...
	<div class="col-sm-8">
		<div class="pipeline white lined-primary">
		  <div class="pipeline-header">
			...
			<div class="b-t padded-v-big"><a class="btn btn-rounded btn-sm btn-success" onClick="return confirm('<?php echo get_phrase('confirm_solved');?>')" href="<?php echo base_url();?>admin/view_report/update/<?php echo $row['report_code'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0154_ok_successful_check"></i> <?php echo get_phrase('mark_solved');?></a></div>
			<?php endif;?>
			</div>
		</div>
