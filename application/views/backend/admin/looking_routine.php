...
<div class="content-w">
  <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="nav nav-tabs upper">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo base_url();?>admin/looking_routine/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo get_phrase('exam_routine');?></span></a>
            </li>
          </ul>
        </div>
      </div>
  <div class="content-i">
	...
	<div style="float:right;vertical-align:middle;"><button class="btn btn-primary btn-rounded btn-upper" data-target="#exampleModal1" data-toggle="modal" type="button">+ <?php echo get_phrase('add');?></button></div>
		<div class="row">
	  <div class="col-sm-5">
						...
						<div class="pi-settings os-dropdown-trigger">
						  ...
						  <div class="os-dropdown">
							...
							<ul>
							  ...
							  <li>
								<a onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')" href="<?php echo base_url();?>admin/exam_routine/delete/<?php echo $row2['horario_id'];?>"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php echo get_phrase('delete');?></span></a>
							  </li>
							</ul>
						  </div>
						</div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <?php echo form_open(base_url() . 'admin/exam_routine/create' , array('target'=>'_top'));?>
			  ...
			  <div class="form-group row">
				  <label class="col-sm-2 col-form-label" for=""> <?php echo get_phrase('date');?></label>
				  <div class="col-sm-10">
				  <div class="input-group">
				  <div class="input-group-addon">
					<i class="picons-thin-icon-thin-0021_calendar_month_day_planner"></i>
				  </div>
				  <input class="single-daterange form-control" placeholder="Date" name="fecha" type="text" value="">
				  </div>
				  </div>
				</div>
			  <div class="form-group row">
             ...
             <div class="form-group row">
				...
				<div class="col-sm-2">
					<div class="input-group">
				  <select class="form-control" name="starting_ampm">
