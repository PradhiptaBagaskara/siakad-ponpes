...
<div class="content-w">
 ...
 <div class="content-i">	
	<div class="content-box">
	  <?php echo form_open(base_url() . 'admin/students_area/', array('class' => 'form m-b'));?>
			  <div class="row">
				<div class="col-sm-4">
		  ...
		  <div class="pi-controls">
			<div class="pi-settings os-dropdown-trigger">
			  ...
			  <div class="os-dropdown">
				...
				<ul>
				  <li>
					<a href="<?php echo base_url();?>admin/student_portal/<?php echo $row['student_id'];?>"><i class="os-icon picons-thin-icon-thin-0699_user_profile_avatar_man_male"></i><span><?php echo get_phrase('profile');?></span></a>
				  </li>
				  <li>
					<a href="<?php echo base_url();?>admin/view_marks/<?php echo $row['student_id'];?>"><i class="os-icon picons-thin-icon-thin-0006_book_writing_reading_read_manual"></i><span><?php echo get_phrase('marks');?></span></a>
				  </li>
				  <li>
					<a onClick="return confirm('<?php echo get_phrase('confirm_delete_student');?>')" href="<?php echo base_url();?>admin/delete_student/<?php echo $row['student_id'];?>/"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php echo get_phrase('delete');?></span></a>
				  </li>
				</ul>
			  </div>
			</div>
		  ...
		  <div class="pi-controls">
			<div class="pi-settings os-dropdown-trigger">
			  ...
			  <div class="os-dropdown">
				...
				<ul>
				  <li>
					<a href="<?php echo base_url();?>admin/student_portal/<?php echo $row2['student_id'];?>"><i class="os-icon picons-thin-icon-thin-0699_user_profile_avatar_man_male"></i><span><?php echo get_phrase('profile');?></span></a>
				  </li>
				  <li>
					<a href="<?php echo base_url();?>admin/view_marks/<?php echo $row2['student_id'];?>"><i class="os-icon picons-thin-icon-thin-0006_book_writing_reading_read_manual"></i><span><?php echo get_phrase('marks');?></span></a>
				  </li>
				  <li>
					<a onClick="return confirm('<?php echo get_phrase('confirm_delete_student');?>')" href="<?php echo base_url();?>admin/delete_student/<?php echo $row2['student_id'];?>/"><i class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php echo get_phrase('delete');?></span></a>
				  </li>
				</ul>
			  </div>
			</div>
