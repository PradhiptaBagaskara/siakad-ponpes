                ...
                <div class="full-chat-i">
                  <div class="full-chat-left">  
                     <div class="chat-heady">
                      ...
                      <div class="userty">
                        <a href="<?php echo base_url();?>student/message/message_new">
                    ...
                    <?php
                      ...
                      $flag++;
                    ?>
                      <a href="<?php echo base_url('student/group/group_message_read/'.$row['group_message_thread_code']); ?>"><div class="user-w  <?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['group_message_thread_code']) echo 'active'; ?>">
                        <div class="user-info">
