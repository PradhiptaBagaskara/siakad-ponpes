      ...
      <div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="nav nav-tabs upper">
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo base_url();?>student/noticeboard/"><i class="os-icon picons-thin-icon-thin-0010_newspaper_reading_news"></i><span><?php echo get_phrase('noticeboard');?></span></a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url();?>student/calendar/"><i class="os-icon picons-thin-icon-thin-0021_calendar_month_day_planner"></i><span><?php echo get_phrase('events');?></span></a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="content-box">
        <div class="pipelines-w">
          <div class="row">
            ...
            foreach($news as $new):?>
            <div class="col-xl-4">
              <a href="<?php echo base_url();?>student/read/<?php echo $new['news_code'];?>"><div class="pipeline white lined-<?php if($new['type'] == 'event') echo 'primary'; else echo 'success';?>">
                <div class="pipeline-header">
                  <h5 class="pipeline-name"><?php echo $new['title'];?></h5>
                    <div class="pipeline-header-numbers">
                      ...
                      <a href="<?php echo base_url();?>student/read/<?php echo $new['news_code'];?>"><div class="element-box" style="padding:0px">
