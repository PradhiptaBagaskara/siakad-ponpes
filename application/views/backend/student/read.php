...
<ul class="breadcrumb hidden-xs-down hidden-sm-down">
	...
	<a href="<?php echo base_url();?>student/noticeboard/"><i class="os-icon os-icon-common-07"></i></a>	
</div></ul> 
  <div class="content-i">
...
<script>
	...
	$(document).ready(function()
	{
	  $("#add").click(function()
	  {
	  	...
	  	{
		  	$.ajax({url:"<?php echo base_url();?>student/news_message/add/",type:'POST',data:{message:message,news_code:news_code},success:function(result)
		  	{
