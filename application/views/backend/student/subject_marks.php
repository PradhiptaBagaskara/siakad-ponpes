...
<div class="content-w">
	<div class="os-tabs-w menu-shad">
        <div class="os-tabs-controls">
          <ul class="nav nav-tabs upper">
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo base_url();?>student/my_marks/"><i class="os-icon picons-thin-icon-thin-0007_book_reading_read_bookmark"></i><span><?php echo get_phrase('subject_marks');?></span></a>
            </li>
          </ul>
        </div>
      </div>
	...
	<a href="<?php echo base_url();?>student/my_marks/"><i class="os-icon os-icon-common-07"></i></a>	
	</div>
	<div class="row">
	<div class="col-sm-8">
