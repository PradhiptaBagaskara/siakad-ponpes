...
<div class="content-w">
	...
	<div class="back">
		<a href="<?php echo base_url();?>parents/student_report/"><i class="os-icon os-icon-common-07"></i></a>
	</div>
	</ul>
  <div class="content-i">
...
<script>
	...
	$(document).ready(function()
	{
	  $("#add").click(function()
	  {
	  	...
	  	{
		  	$.ajax({url:"<?php echo base_url();?>parents/student_report/response/",type:'POST',data:{message:message,report_code:report_code},success:function(result)
		  	{
