...
<ul class="breadcrumb hidden-xs-down hidden-sm-down">
	...
	<a href="<?php echo base_url();?>parents/marks/"><i class="os-icon os-icon-common-07"></i></a>	
</div></ul>
